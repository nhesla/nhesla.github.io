...
public class Jet_creep extends Creep
{ 
    public Jet_creep(int x, int y, int h, int s, int d) 
    {
		super(x, y, h, s, d);
		setC(18);
	}	
	
	public Jet_creep(Creep copy, int d)
    {
    	super(copy, d);
    	setC(18);
    }
    ...
    public void drawCreep(Graphics g)
    {
    	if(health > 0)
	    {
	    	...
	    	part1.addPoint(getX()-(10/diviser),getY()-(30/diviser));
	    	part1.addPoint(getX()+(30/diviser),getY()+(0/diviser));
	    	part1.addPoint(getX()-(10/diviser),getY()+(30/diviser));
	    	part1.addPoint(getX()-(10/diviser),getY()-(30/diviser));
